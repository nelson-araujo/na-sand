...
const file_greet_proto_rawDesc = "" +
	...
	"\x05Greet\x122\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponseB.Z,nelsonaraujo.com/na-sand/go/grpc/greet/protob\x06proto3"
...
var file_greet_proto_depIdxs = []int32{
	0, // 0: greet.Greet.Greet:input_type -> greet.GreetRequest
	1, // 1: greet.Greet.Greet:output_type -> greet.GreetResponse
